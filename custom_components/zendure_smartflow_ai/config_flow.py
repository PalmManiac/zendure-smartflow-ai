        ...
        schema = vol.Schema(
            {
                ...
                # Grid setup (recommended)
                vol.Optional(CONF_GRID_MODE, default=GRID_MODE_NONE): selector.SelectSelector(
                    selector.SelectSelectorConfig(
                        options=[
                            {"value": GRID_MODE_NONE, "label": "Kein Netzsensor (Hausverbrauch nicht berechenbar)"},
