...
class ZendureSmartFlowCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        try:
            ...
            # Recommendation-Freeze
            # =========================
            freeze_allowed = ai_status in ("standby", "pv_laden")

            if freeze_allowed and self._freeze_until and now < self._freeze_until:
            ...
            if recommendation == "entladen":
            ...
            elif recommendation in ("laden", "ki_laden", "billig_laden"):
                await self.hass.services.async_call(
                    "select",
                    "select_option",
                    {
                ...
                in_w = max_charge if recommendation != "laden" else min(max_charge, surplus)
